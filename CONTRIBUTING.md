...
- Bug fix
- Security fix
- Adding new language files (see [these instructions](https://github.com/mayi/dockge/blob/master/frontend/src/lang/README.md))
...
### ❌ Won't be merged:
- A dedicated PR for translating existing languages (see [these instructions](https://github.com/mayi/dockge/blob/master/frontend/src/lang/README.md))
...
I will assign your pull request to a [milestone](https://github.com/mayi/dockge/milestones), if I plan to review and merge it.
